    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
      <Card className="p-3 sm:p-6">
        ...
        <CardContent className="px-0">
          <div className="text-lg sm:text-2xl font-bold">{stats.totalContacts}</div>
      ...
      <Card className="p-3 sm:p-6">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 px-0">
          <CardTitle className="text-xs sm:text-sm font-medium">Campanhas</CardTitle>
          <Megaphone className="h-3 w-3 sm:h-4 sm:w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent className="px-0">
          <div className="text-lg sm:text-2xl font-bold">{stats.totalCampaigns}</div>
          <p className="text-xs text-muted-foreground">
      ...
      <Card className="p-3 sm:p-6">
        ...
        <CardContent className="px-0">
          <div className="text-lg sm:text-2xl font-bold">{stats.contactsThisWeek}</div>
          <p className="text-xs text-muted-foreground">
            Contatos coletados
          </p>
        </CardContent>
